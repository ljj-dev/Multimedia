...
public class Camera extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            imageUri = FileProvider.getUriForFile(this, "com.example.multimedia.fileprovider", outputImage);
            Log.d("CameraAlbum", outputImage.toString() + "手机系统版本高于Android7.0");
        } else {
            // 将File对象转换为Uri对象，这个Uri标识着output_image.jpg这张图片的本地真实路径
            Log.d("CameraAlbum", outputImage.toString() + "手机系统版本低于Android7.0");
        ...
        intent3 = new Intent(getApplicationContext(), CameraAlbum.class);
